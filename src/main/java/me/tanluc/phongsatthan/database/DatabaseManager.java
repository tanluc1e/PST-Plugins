package me.tanluc.phongsatthan.database;
...
public class DatabaseManager {
    ...
    public void updateDatabase(){
        String sql = "INSERT OR REPLACE INTO PLAYERDATA (UUID, COMMON, EPIC, LEGENDARY, TOTAL, COMMON_OWNED, EPIC_OWNED, LEGENDARY_OWNED, TOTAL_OWNED, XP, LEVEL, TOTALXP) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void saveContracts(){
        String sql = "INSERT OR IGNORE INTO MOBDATA (UUID, MOBUUID, DISPLAYNAME, CONTRACTTYPE, TYPE, HEALTH, DAMAGE, DATE) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
