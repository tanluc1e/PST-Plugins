package me.tanluc.phongsatthan.mobs;

import me.tanluc.phongsatthan.events.ContractTargetEvent;
...
public class MobFeatures {
    ...
    public ItemStack giveBow() {
        ...
        if (config.isSet("settings.mob-weapons.bows.enchantments")) {
            for (String key : config.getConfigurationSection("settings.mob-weapons.bows.enchantments").getKeys(false)) {
                ...
                bow.addUnsafeEnchantment(enchantment, level);
            }
        }
    ...
    public ItemStack giveSword() {
        ...
        Material material = config.getString("settings.mob-weapons.swords.type") == "diamond" ? Material.DIAMOND_SWORD
                : config.getString("settings.mob-weapons.swords.type") == "wooden" || config.getString("settings.mob-weapons.swords.type") == "wood" ? Material.WOOD_SWORD
                : config.getString("settings.mob-weapons.swords.type") == "golden" || config.getString("settings.mob-weapons.swords.type") == "gold" ? Material.GOLD_SWORD
